...
2. **`[중앙 2열] STEP 2` (단일 셀카 포토스팟)**:
   - 관람객이 서서 셀카를 촬영할 때 얼굴에 글자나 잡광이 비치지 않도록 방해 요소(`[ STAND HERE ]` 문구, 코너 브래킷 등)를 전면 제거한 **100% 완전 무결 순수 트루 블랙(`#000000`) 백드롭**을 제공합니다.
