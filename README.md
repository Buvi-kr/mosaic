...
- **3.5초 스마트 인체 실루엣 가이드 & 셀카 시점 100% 무반사 트루블랙 완전 소멸 (`display.html`, `session.manager.js`)**:
  - QR 스캔 직후(또는 키오스크 슬롯 점유 시) 관람객이 폰을 확인하고 중앙을 쳐다보는 찰나(약 3.5초) 동안, 중앙 2단계 화면에 **미려한 인체 실루엣 윤곽선**과 **"가운데에 서서 셀카를 준비해주세요"** 안내 배너가 부드럽게 노출.
  - 관람객이 위치를 잡고 셔터를 누르는 순간에 맞춰 0.8초간 부드럽게 페이드아웃되어 **100% 무반사 트루 블랙(`#000000`)**으로 완전 소멸 ➔ 얼굴 빛 반사/눈부심 0% 방어와 초기 위치 가이드 편의성 동시 달성.
