...
### 4-1. 🪄 One-Click 자동 런처 (`start.bat`) 세부 동작
...
│       ├── 1번사진/              # 천주호 (야간) (5,280 타일, 12K Atlas)
│       ├── 2번사진/              # 조각공원 (일몰) (4,416 타일, 12K Atlas)
│       ├── 3번사진/              # 천주호 (겨울) (5,088 타일, 12K Atlas)
│       ├── 4번사진/              # 매표소 앞 (가을) (4,416 타일, 12K Atlas)
│       └── 5번사진/              # 과학관 (4,416 타일, 12K Atlas)
├── scripts/                      # 자동화 빌더 스크립트
